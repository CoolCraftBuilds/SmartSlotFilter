...
Built and confirmed working on **0.4.6f5**. The game is now on 0.4.6f11 and this has not
been re-verified against it. The mod hooks `FilterConfigPanel.OpenDropdown` and reads
